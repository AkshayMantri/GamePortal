...
| GP-2-001G | READY                                 | New fresh independent tester required | GP-2-001F                           | First context stopped at `format:check` after the root-owned ledger update; no later checks ran. Formatting and state were reconciled before this rerun packet | Execute full integrated-candidate regression |
